CLASS zbrt_travel_app_class_1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zbrt_travel_app_class_1 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

DATA itab TYPE TABLE OF zbrt_travel_t1.
...
*   delete existing entries in the database table
    DELETE FROM zbrt_travel_t1.

*   insert the new table entries
    INSERT zbrt_travel_t1 FROM TABLE @itab.
