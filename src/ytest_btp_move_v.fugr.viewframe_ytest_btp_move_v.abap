*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YTEST_BTP_MOVE_V
*   generation date: 07.07.2021 at 10:23:56
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YTEST_BTP_MOVE_V    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YTEST_BTP_MOVE_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YTEST_BTP_MOVE_V_EXTRACT
TOTAL = YTEST_BTP_MOVE_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YTEST_BTP_MOVE_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YTEST_BTP_MOVE_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YTEST_BTP_MOVE_V_EXTRACT
TOTAL = YTEST_BTP_MOVE_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YTEST_BTP_MOVE_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YTEST_BTP_MOVE_V'
...
TOTAL = YTEST_BTP_MOVE_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YTEST_BTP_MOVE_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YTEST_BTP_MOVE_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YTEST_BTP_MOVE_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YTEST_BTP_MOVE_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YTEST_BTP_MOVE_V_EXTRACT
TOTAL = YTEST_BTP_MOVE_V_TOTAL
